"""dcnn_001: model architecture, training, prediction, and artifacts."""
...
def run(config, prepared, artifact_dir):
    if config["experiment"] != "dcnn_001":
        raise ValueError("dcnn_001.run received the wrong experiment config")
